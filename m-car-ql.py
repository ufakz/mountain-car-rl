...
# Import and initialize Mountain Car env
...
def QLearning(env, learning, discount, epsilon, min_eps, episodes):
    print('Training using Reinforcement Learning (Q-Learning)')
...
rand_rewards = random_agent(env, 5000)
Q_rewards = QLearning(env, 0.2, 0.9, 0.8, 0, 5000)

# Plot rewards

# Random agent results
plot_graph(rewards=rand_rewards)

# Q Learning rewards
plot_graph(rewards=Q_rewards)
